...
--
-- Host: localhost    Database: projectsod
-- ------------------------------------------------------
...
CREATE TABLE `sensor_data` (
  ...
  `luminosity` decimal(5,2) NOT NULL,
  `ledstate` varchar(3) NOT NULL,
...
-- Dump completed on 2023-08-05 20:56:18
